...
struct RunStopBuilder {
  ...
  void add_command_id(::flatbuffers::Offset<::flatbuffers::String> command_id) {
    fbb_.AddOffset(RunStop::VT_COMMAND_ID, command_id);
  }
...
inline RunStop *GetMutableSizePrefixedRunStop(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<RunStop>(buf);
}
...
inline bool SizePrefixedRunStopBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RunStopIdentifier(), true);
}
