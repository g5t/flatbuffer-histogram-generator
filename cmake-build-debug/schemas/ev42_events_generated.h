...
inline const char *EnumNameFacilityData(FacilityData e) {
  if (::flatbuffers::IsOutRange(e, FacilityData::NONE, FacilityData::AdcPulseDebug)) return "";
...
bool VerifyFacilityDataVector(::flatbuffers::Verifier &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<FacilityData> *types);
...
struct EventMessage FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_FACILITY_SPECIFIC_DATA_TYPE, 1) &&
...
inline bool VerifyFacilityDataVector(::flatbuffers::Verifier &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<FacilityData> *types) {
